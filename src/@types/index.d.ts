...
// @ts-ignore
import core from "../hooks/video/index";

export interface JitsiProps
  extends React.HTMLProps<React.ReactElement<any, any>> {
...
export const JitsiMeet: (props: JitsiProps) => ReactElement = core.JitsiMeet;
